			...
			events: [
				{
					...
					roles: {
						'Check-In': ['Chelsea Hale', 'Sarah Fox', 'Heather Fick'],
				...
				},
				{
					...
					roles: {
						'Fast Track': ['Keith McClymonds', 'Niki McClymonds', 'Chip Crawford', 'Nick Smith'],
					},
				},
				{
			...
			events: [
				{
					...
					roles: {
						...
						'Team Helper': ['Julia Larson', 'Amelia Munger', 'Chip Crawford', 'Keith McClymonds'],
				...
				},
				{
					...
					inCharge: ['Chelsea Hale'],
					roles: {
						'Progress Tracking': ['Chelsea Hale', 'Sarah Fox', 'Heather Fick'],
					},
				},
				{
					title: 'Cubbies - Music',
			...
			events: [
				...
				},
				{
					...
					roles: {
						...
						'Fast Track - Sparks': ['Amelia Munger', 'Ella Albert', 'Lexi Boardman'],
					},
				},
				{
					title: 'Admin',
			...
			events: [
				{
					...
					roles: {
						Teacher: ['Brad Parker'],
						'Lesson Helper': ['Lexi Boardman', 'Ella Albert', 'Amelia Munger', 'Sonia Williamson', 'Jimmy Williamson'],
					},
				},
				{
